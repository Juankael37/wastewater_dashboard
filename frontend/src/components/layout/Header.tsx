      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-white">Wastewater Monitor</h1>
              <p className="text-sm text-gray-500 dark:text-slate-400">Treatment Plant Monitoring System</p>
            </div>
          </div>
        </div>
